...
app.MapPost("/api/products", async (frontend.Models.Product product, ApplicationDbContext context) =>
{
...
app.MapPut("/api/products/{id}", async (int id, frontend.Models.Product updatedProduct, ApplicationDbContext context) =>
{
...
app.MapPost("/api/users", async (frontend.Models.User user, ApplicationDbContext context) =>
{
...
app.MapPut("/api/users/{id}", async (int id, frontend.Models.User updatedUser, ApplicationDbContext context) =>
{
...
app.MapPost("/api/orders", async (frontend.Models.Order order, ApplicationDbContext context) =>
{
...
app.MapPut("/api/orders/{id}", async (int id, frontend.Models.Order updatedOrder, ApplicationDbContext context) =>
{
...
app.MapPost("/api/servicerecords", async (frontend.Models.ServiceRecord serviceRecord, ApplicationDbContext context) =>
{
...
app.MapPut("/api/servicerecords/{id}", async (int id, frontend.Models.ServiceRecord updatedServiceRecord, ApplicationDbContext context) =>
{
